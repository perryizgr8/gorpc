...
func (c *pingClient) Ping(ctx context.Context, in *EchoRequest, opts ...grpc.CallOption) (*EchoResponse, error) {
	out := new(EchoResponse)
	err := c.cc.Invoke(ctx, "/procedures.Ping/Ping", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedPingServer) Ping(context.Context, *EchoRequest) (*EchoResponse, error) {
...
func _Ping_Ping_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/procedures.Ping/Ping",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PingServer).Ping(ctx, req.(*EchoRequest))
	}
...
var Ping_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "procedures/procedures.proto",
}
